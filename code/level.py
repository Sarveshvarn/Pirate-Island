        ...
        for row_index, row in enumerate(layout):
            for col_index, val in enumerate(row):
                if val != '-1':
                    ...
                    if type == 'coins':
                        if val == '0': sprite = Coin(TILESIZE,x,y,'graphics/coins/gold',5)
                        if val == '1': sprite = Coin(TILESIZE,x,y,'graphics/coins/silver',1)
        ...
        for row_index, row in enumerate(layout):
            for col_index, val in enumerate(row):
                ...
                if val == '1':
                    ...
                    sprite = StaticTile(TILESIZE,x,y,hat_surface)
